                        ...
                        <div class="card-body">
                            <nav>
                                <div class="nav nav-tabs" id="nav-tab" role="tablist">
                                    ...
                                    <a class="nav-item nav-link" id="nav-mahasiswa-tab" data-toggle="tab" href="#nav-mahasiswa" role="tab" aria-controls="nav-mahasiswa"
                    ...
                    <form action="{{ route('user.store', ['role' => 'admin']) }}" method="post" autocomplete="off" id="form-admin">
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="invalid-feedback" name="msg_username">
                                    <ul></ul>
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <label for="">Ulangi Password <span class="text-danger">*</span></label>
                    ...
                    <form action="" method="post" autocomplete="off" id="form-admin-edit">
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="invalid-feedback" name="msg_password_edit">
                                    <ul></ul>
                                </div>
                            </div>
                            <div class="form-group">
        ...
        <div class="modal fade" id="studentModalEdit" tabindex="-1" role="dialog">
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    ...
                    <form action="{{ route('student.update') }}" method="post" autocomplete="off" id="form-student-edit">
                        <div class="modal-body">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control numeric" name="nim" id="nim" required>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <div class="invalid-feedback" name="msg_email" required>
                                                    <ul></ul>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control numeric" name="no_hp" id="no_hp">
                                                <div class="invalid-feedback" name="msg_no_hp" required>
                                                    <ul></ul>
                                                </div>
                                            </div>
                                        </div>
        ...
        <div class="modal fade" id="teacherModalEdit" tabindex="-1" role="dialog">
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    ...
                    <form action="{{ route('teacher.update') }}" method="post" autocomplete="off" id="form-teacher-edit">
                        <div class="modal-body">
                            <input type="hidden" name="id" value="">
                            <div class="row">
                                <div class="col-lg-12">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control numeric" name="nidn" id="nidn" required>
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                <div class="custom-file">
                                    ...
                                    <div class="invalid-feedback" name="msg_file">
                                        <ul></ul>
                                    </div>
                                </div>
...
@push('css')
    ...
    <link rel="stylesheet" href="{{ asset('vendor/datatables/buttons-1.6.5/css/buttons.dataTables.min.css') }}">
    {{-- Selectric --}}
