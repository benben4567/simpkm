              ...
              @foreach ($proposal->reviews as $review )
                <div class="activity">
                  ...
                  <div class="activity-detail w-100">
                    ...
                    @elseif ($review->type == 'student')
                    <a class="btn btn-info mt-3" href="{{ route('proposal.download', ['file' => $review->file]) }}" target="_blank" role="button"><i class="fas fa-download"></i> Hasil Revisi</a>
                    @elseif ($review->type == 'teacher')
                    <a class="btn btn-success mt-3" href="{{ route('proposal.download', ['file' => $review->file]) }}" target="_blank" role="button"><i class="fas fa-download"></i> Hasil Review</a>
                  @endif
                  </div>
                </div>
              @endforeach
