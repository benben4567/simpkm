...
<li class="{{ set_active('monitoring.database.index') }}"><a class="nav-link" href="{{ route('monitoring.database.index') }}"><i class="fas fa-database"></i> <span>Database</span></a></li>
...
<li class="nav-item dropdown">
    ...
    <ul class="dropdown-menu">
        ...
        <li class="{{ set_active(['role.index']) }}"><a class="nav-link" href="{{ route('role.index') }}">Grup</a></li>
        <li class="{{ set_active(['permission.index']) }}"><a class="nav-link" href="{{ route('permission.index') }}">Hak Akses</a></li>
    </ul>
</li>
